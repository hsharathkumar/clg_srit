  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-10">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div>
          ...
          <p className="text-slate-500 text-sm max-w-2xl leading-relaxed">
            Engineering the future with Srinivasa Ramanujan Institute of Technology. Where academic excellence meets computational innovation.
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6">
        ...
        {/* Large Card: The AI Innovation Nexus */}
        <div className="md:col-span-2 lg:col-span-3 bg-white border border-slate-200/80 p-8 rounded-3xl relative overflow-hidden flex flex-col justify-between shadow-sm">
          <div className="max-w-md z-10 space-y-4">
            <h3 className="text-sm font-bold text-slate-500">The AI Innovation Nexus</h3>
            <p className="text-slate-700 text-sm leading-relaxed">
              Our premier laboratory equipped with NVIDIA A100 clusters, fostering research in Generative AI, Computer Vision, and Neural Architectures.
            </p>
        ...
        <div className="bg-white border border-slate-200/80 p-6 rounded-3xl flex flex-col items-center justify-center text-center shadow-sm">
          ...
          <span className="text-2xl font-black text-[#002b5c]">12.5 TFLOPS</span>
          <span className="text-[10px] font-mono font-bold text-slate-400 uppercase tracking-widest mt-1">COMPUTING POWER</span>
        </div>

        {/* Card: 98% Placement Rate */}
        <div className="bg-white border border-slate-200/80 p-6 rounded-3xl flex flex-col items-center justify-center text-center shadow-sm">
          <span className="text-4xl font-black text-[#002b5c]">98%</span>
        ...
        <div className="bg-white border border-slate-200/80 p-6 rounded-3xl flex items-center justify-between col-span-1 lg:col-span-2 shadow-sm">
          <div>
            ...
            <p className="text-xs text-slate-700 font-medium">50+ International publications in 2023 alone.</p>
          </div>
        ...
        <div className="bg-white border border-slate-200/80 p-8 rounded-3xl md:col-span-2 lg:col-span-3 flex flex-col justify-between shadow-sm">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h4 className="text-xs font-bold text-slate-800 mb-1">Quantum Preparedness</h4>
                <p className="text-xs text-slate-500 leading-relaxed">Integrating quantum computing fundamentals into our core AI curriculum.</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              ...
              <div>
                <h4 className="text-xs font-bold text-slate-800 mb-1">Ethical Frameworks</h4>
                <p className="text-xs text-slate-500 leading-relaxed">Developing AI that is transparent, accountable, and socially responsible.</p>
              </div>
            </div>
          </div>
        ...
        <div className="bg-white border border-slate-200/80 p-6 rounded-3xl flex flex-col items-center justify-center text-center relative overflow-hidden shadow-sm">
          <div className="bg-slate-50 border border-slate-200 px-6 py-4 rounded-2xl">
            <span className="text-[9px] font-mono font-extrabold text-slate-400 uppercase tracking-widest block mb-1">NEURAL ENGINE</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white border border-slate-200/80 p-6 rounded-3xl flex flex-col justify-between shadow-sm">
            <div>
              ...
              <h3 className="text-sm font-extrabold text-[#002b5c] mb-2">Deep Learning</h3>
              <p className="text-xs text-slate-500 leading-relaxed mb-6">Mastering CNNs, RNNs, and Transformers for high-performance AI modeling.</p>
            </div>
            <div>
              <div className="w-full bg-slate-100 h-1.5 rounded-full overflow-hidden mb-2">
                <div className="bg-[#FFBF00] h-full rounded-full" style={{ width: '75%' }}></div>
              </div>
              <span className="text-[10px] font-mono font-bold text-slate-500 uppercase tracking-widest">Track Progress: 75%</span>
            </div>
          </div>
          ...
          <div className="bg-white border border-slate-200/80 p-6 rounded-3xl flex flex-col justify-between shadow-sm">
            <div>
              ...
              <h3 className="text-sm font-extrabold text-[#002b5c] mb-2">Big Data Engineering</h3>
              <p className="text-xs text-slate-500 leading-relaxed mb-6">Building scalable data pipelines using Apache Spark and Hadoop ecosystems.</p>
            </div>
            <div>
              <div className="w-full bg-slate-100 h-1.5 rounded-full overflow-hidden mb-2">
                <div className="bg-[#FFBF00] h-full rounded-full" style={{ width: '50%' }}></div>
              </div>
              <span className="text-[10px] font-mono font-bold text-slate-500 uppercase tracking-widest">Track Progress: 50%</span>
            </div>
          </div>
          ...
          <div className="bg-white border border-slate-200/80 p-6 rounded-3xl flex flex-col justify-between shadow-sm">
            <div>
              ...
              <h3 className="text-sm font-extrabold text-[#002b5c] mb-2">Robotics & IoT</h3>
              <p className="text-xs text-slate-500 leading-relaxed mb-6">Integrating AI with physical systems for edge computing applications.</p>
            </div>
            <div>
              <div className="w-full bg-slate-100 h-1.5 rounded-full overflow-hidden mb-2">
                <div className="bg-[#FFBF00] h-full rounded-full" style={{ width: '33%' }}></div>
              </div>
              <span className="text-[10px] font-mono font-bold text-slate-500 uppercase tracking-widest">Track Progress: 33%</span>
            </div>
          </div>
        </div>
      </section>
